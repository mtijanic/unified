...
{
    CCodeBaseInternal__CCodeBaseInternalCtor(this);
}

CCodeBaseInternal::~CCodeBaseInternal()
{
    CCodeBaseInternal__CCodeBaseInternalDtor(this);
}
...
void CCodeBaseInternal__CCodeBaseInternalCtor(CCodeBaseInternal* thisPtr)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, char, void*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, float);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, const CScriptLocation&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, SCodeBaseData*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, SCodeBaseData*, CExoString&, CExoString&, int32_t&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, const Vector&);
...
{
    using FuncPtrType = void(__fastcall *)(CCodeBaseInternal*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CCodeBaseInternal*, int, CExoString&);
...
{
    using FuncPtrType = void*(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&, char&, int32_t&);
...
{
    using FuncPtrType = SCodeBaseData*(__fastcall *)(CCodeBaseInternal*, int, CExoString&, int32_t);
...
{
    using FuncPtrType = float(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&);
...
{
    using FuncPtrType = CScriptLocation*(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&);
...
{
    using FuncPtrType = CExoString*(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&);
...
{
    using FuncPtrType = Vector*(__fastcall *)(CCodeBaseInternal*, int, CExoString&, CExoString&, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CCodeBaseInternal*, int, CExoString&, int32_t);
