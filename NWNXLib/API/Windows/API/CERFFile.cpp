...
void CERFFile__CERFFileCtor(CERFFile* thisPtr)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, char*, uint16_t, CRes*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, CERFString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, CERFRes*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, CExoString&, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CERFFile*, int, char*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CERFFile*, int, char*, uint16_t, CRes*, int32_t);
