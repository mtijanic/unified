...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedCExoString*, int, CExoString);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoArrayListTemplatedCExoString*, int, CExoString);
...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedCExoString*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedCExoString*, int, CExoString, int32_t);
