...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedCNWItemProperty*, int, CNWItemProperty);
...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedCNWItemProperty*, int, int32_t);
...
{
    using FuncPtrType = CExoArrayListTemplatedCNWItemProperty&(__fastcall *)(CExoArrayListTemplatedCNWItemProperty*, int, const CExoArrayListTemplatedCNWItemProperty&);
