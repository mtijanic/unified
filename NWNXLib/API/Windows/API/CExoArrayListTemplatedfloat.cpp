...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedfloat*, int, int);
...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedfloat*, int, float);
...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedfloat*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoArrayListTemplatedfloat*, int, float, int32_t);
