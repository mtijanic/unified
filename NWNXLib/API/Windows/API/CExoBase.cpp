...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoBase*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoBase*, int, CExoArrayListTemplatedCFileInfo*, CExoString, uint16_t, int32_t);
...
{
    using FuncPtrType = const CExoString&(__fastcall *)(CExoBase*, int, uint16_t);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CExoBase*, int, const CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CExoBase*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoBase*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CExoBase*, int, const CExoString&, const CExoString&, int32_t);
