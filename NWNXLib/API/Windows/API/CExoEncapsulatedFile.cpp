...
{
    CExoEncapsulatedFile__CExoEncapsulatedFileCtor(this);
}
...
void CExoEncapsulatedFile__CExoEncapsulatedFileCtor(CExoEncapsulatedFile* thisPtr)
{
...
void CExoEncapsulatedFile__CExoEncapsulatedFileDtor__0(CExoEncapsulatedFile* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoEncapsulatedFile__CExoEncapsulatedFileDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>    (address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoEncapsulatedFile*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoEncapsulatedFile*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoEncapsulatedFile*, int, unsigned char);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoEncapsulatedFile*, int, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoEncapsulatedFile*, int, uint32_t, void*, uint32_t, uint32_t);
