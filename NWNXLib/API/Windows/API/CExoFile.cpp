...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoFile*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFile*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFile*, int, CExoString&, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFile*, int, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoFile*, int, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoFile*, int, int32_t, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFile*, int, const CExoString&);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFile*, int, const char*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFile*, int, const void*, uint32_t, uint32_t);
