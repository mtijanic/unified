...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoFileInternal*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoFileInternal*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CExoFileInternal*, int, void*, uint32_t, uint32_t);
