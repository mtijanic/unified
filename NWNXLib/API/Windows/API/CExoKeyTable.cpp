...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoKeyTable*, int, int32_t);
...
{
    using FuncPtrType = CKeyTableEntry*(__fastcall *)(CExoKeyTable*, int, const CResRef&, uint16_t, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoKeyTable*, int, int32_t, unsigned char*);
...
{
    using FuncPtrType = CKeyTableEntry*(__fastcall *)(CExoKeyTable*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoKeyTable*, int, uint32_t, const CExoString&, uint32_t, int32_t, unsigned char*);
...
{
    using FuncPtrType = void(__fastcall *)(CExoKeyTable*, int, CExoLinkedListTemplatedCKeyTableInfo*);
...
{
    using FuncPtrType = CKeyTableEntry*(__fastcall *)(CExoKeyTable*, int, CRes*);
...
{
    using FuncPtrType = CKeyTableEntry*(__fastcall *)(CExoKeyTable*, int, const CResRef&, uint16_t);
...
{
    using FuncPtrType = CExoStringList*(__fastcall *)(CExoKeyTable*, int, uint16_t);
...
{
    using FuncPtrType = CRes*(__fastcall *)(CExoKeyTable*, int, const CResRef&, uint16_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoKeyTable*, int, const CResRef&, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoKeyTable*, int, uint32_t, CResRef&, uint16_t&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoKeyTable*, int, uint32_t&, const CResRef&, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoKeyTable*, int, const CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CExoKeyTable*, int, unsigned char*);
