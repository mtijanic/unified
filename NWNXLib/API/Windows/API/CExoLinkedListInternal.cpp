...
{
    using FuncPtrType = void(__fastcall *)(CExoLinkedListInternal*, int, int);
...
{
    using FuncPtrType = CExoLinkedListNode*(__fastcall *)(CExoLinkedListInternal*, int, void*, CExoLinkedListNode*);
...
{
    using FuncPtrType = CExoLinkedListNode*(__fastcall *)(CExoLinkedListInternal*, int, void*);
...
{
    using FuncPtrType = void*(__fastcall *)(CExoLinkedListInternal*, int, CExoLinkedListNode*);
...
{
    using FuncPtrType = void*(__fastcall *)(CExoLinkedListInternal*, int);
