...
{
    CExoLocString__CExoLocStringCtor__1(this, a0);
}

CExoLocString::~CExoLocString()
{
    CExoLocString__CExoLocStringDtor(this);
}
...
{
    using FuncPtrType = void(__fastcall *)(CExoLocString*, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoLocString__CExoLocStringCtor__0);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr);
}

void CExoLocString__CExoLocStringCtor__1(CExoLocString* thisPtr, const CExoLocString& a0)
{
    using FuncPtrType = void(__fastcall *)(CExoLocString*, int, const CExoLocString&);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoLocString__CExoLocStringCtor__1);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, a0);
}
...
{
    using FuncPtrType = void(__fastcall *)(CExoLocString*, int, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CExoLocString__CExoLocStringDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    func(thisPtr, 2);
}
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoLocString*, int, int32_t, CExoString, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoLocString*, int, uint32_t, int32_t*, CExoString*, unsigned char*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoLocString*, int, int32_t, CExoString*, unsigned char, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoLocString*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoLocString*, int, int32_t, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoLocString*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoLocString*, int, CExoLocString&);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CExoLocString*, int, const CExoLocString&);
...
{
    using FuncPtrType = void(__fastcall *)(CExoLocString*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoLocString*, int, int32_t, unsigned char);
