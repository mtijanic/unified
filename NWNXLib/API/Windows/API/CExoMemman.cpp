...
{
    using FuncPtrType = void(__fastcall *)(CExoMemman*, int, uint32_t);
...
{
    using FuncPtrType = void*(__fastcall *)(CExoMemman*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoMemman*, int);
...
{
    using FuncPtrType = CExoMemHeapStats(__fastcall *)(CExoMemman*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CExoMemman*, int, void*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoMemman*, int);
...
{
    using FuncPtrType = CExoMemHeap*(__fastcall *)(CExoMemman*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoMemman*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoMemman*, int, CMemRecord&);
...
{
    using FuncPtrType = void(__fastcall *)(CExoMemman*, int, CMemRecord&, int32_t);
