...
{
    using FuncPtrType = void(__fastcall *)(CExoResFile*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoResFile*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoResFile*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoResFile*, int, unsigned char);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CExoResFile*, int, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoResFile*, int, uint32_t, void*, uint32_t, uint32_t);
