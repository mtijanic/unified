...
{
    CExoString__CExoStringCtor__4(this, a0, a1);
}
...
void CExoString__CExoStringCtor__4(CExoString* thisPtr, const char* a0, int32_t a1)
{
...
{
    using FuncPtrType = float(__fastcall *)(CExoString*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoString*, int);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CExoString*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoString*, int, const CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoString*, int, const CExoString&, int32_t);
...
{
    using FuncPtrType = char*(__fastcall *)(CExoString*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoString*, int, char, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoString*, int, const CExoString&, int32_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CExoString*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoString*, int, const char*);
...
{
    using FuncPtrType = char(__fastcall *)(CExoString*, int, int32_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CExoString*, int, const CExoString&);
...
{
    using FuncPtrType = CExoString&(__fastcall *)(CExoString*, int, const char*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoString*, int, int32_t, int32_t, int32_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CExoString*, int, int32_t, int32_t);
