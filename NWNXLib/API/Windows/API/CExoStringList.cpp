...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int, CExoStringList*);
...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int, int32_t, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int, int);
...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CExoStringList*, int);
...
{
    using FuncPtrType = CExoString*(__fastcall *)(CExoStringList*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int, CExoString*, int32_t);
...
{
    using FuncPtrType = CExoStringList*(__fastcall *)(CExoStringList*, int, CExoStringList*, int32_t, int32_t);
...
{
    using FuncPtrType = CExoStringList&(__fastcall *)(CExoStringList*, int, CExoStringList&);
...
{
    using FuncPtrType = void(__fastcall *)(CExoStringList*, int, int32_t);
