...
{
    CFactionManager__CFactionManagerCtor(this);
}

CFactionManager::~CFactionManager()
{
    CFactionManager__CFactionManagerDtor(this);
}
...
{
    using FuncPtrType = void(__fastcall *)(CFactionManager*, int, int32_t);
...
{
    using FuncPtrType = CExoArrayListTemplatedint*(__fastcall *)(CFactionManager*, int);
...
{
    using FuncPtrType = CNWSFaction*(__fastcall *)(CFactionManager*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CFactionManager*, int, const CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CFactionManager*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CFactionManager*, int, int32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CFactionManager*, int, CResGFF*, CResList*);
...
{
    using FuncPtrType = void(__fastcall *)(CFactionManager*, int, int32_t, int32_t, int32_t);
