...
{
    CGameEffect__CGameEffectCtor__1(this, a0, a1);
}

CGameEffect::~CGameEffect()
{
    CGameEffect__CGameEffectDtor(this);
}
...
{
    using FuncPtrType = CExoString(__fastcall *)(CGameEffect*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, uint32_t*, uint32_t*);
...
{
    using FuncPtrType = float(__fastcall *)(CGameEffect*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CGameEffect*, int, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CGameEffect*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CGameEffect*, int);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CGameEffect*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CGameEffect*, int, const CGameEffect&);
...
{
    using FuncPtrType = CGameEffect&(__fastcall *)(CGameEffect*, int, const CGameEffect&);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, const CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, int32_t, float);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, CGameEffect*, CGameEffect*);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, int32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int, int32_t, CExoString);
...
{
    using FuncPtrType = void(__fastcall *)(CGameEffect*, int);
