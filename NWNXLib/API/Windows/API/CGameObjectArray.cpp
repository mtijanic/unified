...
{
    using FuncPtrType = unsigned char(__fastcall *)(CGameObjectArray*, int, uint32_t, CGameObject*);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CGameObjectArray*, int, uint32_t&, CGameObject*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CGameObjectArray*, int, uint16_t);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CGameObjectArray*, int, uint32_t);
