...
{
    CItemRepository__CItemRepositoryCtor(this, a0, a1, a2, a3, a4);
}

CItemRepository::~CItemRepository()
{
    CItemRepository__CItemRepositoryDtor(this);
}
...
void CItemRepository__CItemRepositoryCtor(CItemRepository* thisPtr, uint32_t a0, unsigned char a1, unsigned char a2, uint32_t a3, int32_t a4)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int, CNWSItem**, unsigned char, unsigned char, int32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CItemRepository*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int, CNWSItem*, unsigned char, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int, CNWSItem*, CNWSItem*, unsigned char, unsigned char);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CItemRepository*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CItemRepository*, int, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int, CNWSItem*, unsigned char&, unsigned char&, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int, CNWSItem*, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CItemRepository*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = CNWSItem*(__fastcall *)(CItemRepository*, int, CExoLinkedListNode*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CItemRepository*, int, CExoLinkedListNode*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CItemRepository*, int, CNWSItem*);
