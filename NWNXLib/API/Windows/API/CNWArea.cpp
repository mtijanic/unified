...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, uint32_t, const Vector&, const Vector&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, uint32_t, const Vector&, const Vector&, int32_t, Vector*, int32_t, int32_t*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWArea*, int, int32_t*, Vector*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, uint32_t, CExoArrayListTemplatedCGameObjectPtr*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWArea*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, float, float, float, float, float, float, float, uint32_t, uint32_t&, int32_t, CExoArrayListTemplatedCGameObjectPtr*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, float, float, float, float, float, float, float, float, float*, float*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, float, float, float, float, CPathfindInformation*, int32_t, int32_t, uint32_t*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, float, float, float, float, float, float, float, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWArea*, int, int32_t, uint32_t, const Vector&, const Vector&, int32_t, Vector*, int32_t, int32_t*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, int32_t, Vector);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWArea*, int, unsigned char);
