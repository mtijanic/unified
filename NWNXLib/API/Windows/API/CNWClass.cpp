...
CNWClass::CNWClass()
{
    CNWClass__CNWClassCtor(this);
}

CNWClass::~CNWClass()
{
    CNWClass__CNWClassDtor(this);
}
...
void CNWClass__CNWClassCtor(CNWClass* thisPtr)
{
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWClass*, int, unsigned char);
...
{
    using FuncPtrType = CNWClass_Feat*(__fastcall *)(CNWClass*, int, uint16_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWClass*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWClass*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWClass*, int, uint16_t);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWClass*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWClass*, int, unsigned char, unsigned char, unsigned char, uint16_t, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWClass*, int, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWClass*, int, uint16_t, unsigned char&);
...
{
    using FuncPtrType = void(__fastcall *)(CNWClass*, int, CExoString);
...
{
    using FuncPtrType = void(__fastcall *)(CNWClass*, int, CExoString, CNWRules*);
