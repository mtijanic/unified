...
void CNWDoorSurfaceMesh__CNWDoorSurfaceMeshCtor(CNWDoorSurfaceMesh* thisPtr)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWDoorSurfaceMesh*, int, Vector, Vector, Vector&, Vector&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWDoorSurfaceMesh*, int, Vector, Vector, Vector, Vector, Vector*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWDoorSurfaceMesh*, int, CResRef);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWDoorSurfaceMesh*, int, unsigned char**, uint32_t*, unsigned char*, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWDoorSurfaceMesh*, int, int32_t, float, float, float, float, float, float, float);
