...
void CNWMessage__CNWMessageDtor__0(CNWMessage* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWMessage__CNWMessageDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>    (address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWMessage*, int, unsigned char**, uint32_t*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWMessage*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWMessage*, int);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWMessage*, int, unsigned char);
...
{
    using FuncPtrType = int64_t(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = char(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = CResRef(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = double(__fastcall *)(CNWMessage*, int, double, int32_t);
...
{
    using FuncPtrType = double(__fastcall *)(CNWMessage*, int, double, double, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = uint64_t(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = float(__fastcall *)(CNWMessage*, int, float, int32_t);
...
{
    using FuncPtrType = float(__fastcall *)(CNWMessage*, int, float, float, int32_t);
...
{
    using FuncPtrType = int16_t(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = void*(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CNWMessage*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWMessage*, int, unsigned char*, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, uint64_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, unsigned char, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, CExoString, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, char, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, CResRef, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, double, double, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, double, double, double, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, int64_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, int16_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, void*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWMessage*, int, uint16_t, int32_t);
