...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWNameGen*, int);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWNameGen*, int, uint16_t, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWNameGen*, int, CExoString);
