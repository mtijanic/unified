...
{
    CNWSAmbientSound__CNWSAmbientSoundCtor(this, a0);
}
...
void CNWSAmbientSound__CNWSAmbientSoundCtor(CNWSAmbientSound* thisPtr, uint32_t a0)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSAmbientSound*, int, CExoArrayListTemplatedunsignedlong*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSAmbientSound*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAmbientSound*, int, CNWSMessage*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAmbientSound*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAmbientSound*, int, CResGFF*, CResStruct*);
