...
{
    CNWSAreaOfEffectObject__CNWSAreaOfEffectObjectCtor(this, a0);
}
...
void CNWSAreaOfEffectObject__CNWSAreaOfEffectObjectCtor(CNWSAreaOfEffectObject* thisPtr, uint32_t a0)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int);
...
{
    using FuncPtrType = CNWSAreaOfEffectObject*(__fastcall *)(CNWSAreaOfEffectObject*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSAreaOfEffectObject*, int);
...
{
    using FuncPtrType = Vector(__fastcall *)(CNWSAreaOfEffectObject*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSAreaOfEffectObject*, int, Vector);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, CNWSArea*, const Vector&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSAreaOfEffectObject*, int, Vector, Vector);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSAreaOfEffectObject*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, const Vector&);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, unsigned char, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, unsigned char, float, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSAreaOfEffectObject*, int, Vector*);
