...
{
    CNWSBarter__CNWSBarterDtor(this);
}
...
void CNWSBarter__CNWSBarterCtor(CNWSBarter* thisPtr, CNWSCreature* a0)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSBarter*, int, uint32_t, unsigned char&, unsigned char&);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSBarter*, int);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSBarter*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSBarter*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSBarter*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSBarter*, int, int32_t);
