...
{
    CNWSCombatRound__CNWSCombatRoundCtor(this, a0);
}

CNWSCombatRound::~CNWSCombatRound()
{
    CNWSCombatRound__CNWSCombatRoundDtor(this);
}
...
void CNWSCombatRound__CNWSCombatRoundCtor(CNWSCombatRound* thisPtr, CNWSCreature* a0)
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, CNWSCreature*);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSCombatRound__CNWSCombatRoundCtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    int edx = 0;
    func(thisPtr, edx, a0);
}

void CNWSCombatRound__CNWSCombatRoundDtor(CNWSCombatRound* thisPtr)
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSCombatRound__CNWSCombatRoundDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>(address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, CNWSCombatRoundAction*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, uint16_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, uint32_t, uint32_t, unsigned char, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSCombatRound*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSCombatRound*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSCombatRound*, int, uint32_t, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, int32_t);
...
{
    using FuncPtrType = CNWSCombatRoundAction*(__fastcall *)(CNWSCombatRound*, int);
...
{
    using FuncPtrType = CNWSCombatAttackData*(__fastcall *)(CNWSCombatRound*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSCombatRound*, int, uint32_t);
...
{
    using FuncPtrType = CNWSItem*(__fastcall *)(CNWSCombatRound*, int, int32_t);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CNWSCombatRound*, int);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CNWSCombatRound*, int, int32_t);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSCombatRound*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, uint16_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSCombatRound*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSCombatRound*, int, int32_t, uint32_t);
