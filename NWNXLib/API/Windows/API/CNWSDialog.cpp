...
void CNWSDialog__CNWSDialogCtor(CNWSDialog* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDialog*, int, const CExoString&, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, CNWSObject*, const CResRef&);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDialog*, int, uint32_t);
...
{
    using FuncPtrType = CNWSObject*(__fastcall *)(CNWSDialog*, int, CNWSObject*, const CExoString&);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSDialog*, int, CNWSObject*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, CNWSObject*, CExoLocString&, CResRef&, CResRef&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, uint32_t, CNWSObject*, uint32_t, int32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, CResGFF*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDialog*, int, CNWSObject*, const CResRef&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, CNWSObject*, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDialog*, int, CNWSObject*, uint32_t);
...
{
    using FuncPtrType = float(__fastcall *)(CNWSDialog*, int, CNWSObject*, CExoLocString, uint32_t, int32_t);
