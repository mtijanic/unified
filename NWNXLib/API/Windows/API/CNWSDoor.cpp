...
{
    using FuncPtrType = void(__fastcall *)(CNWSDoor*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDoor*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDoor*, int);
...
{
    using FuncPtrType = CNWSDoor*(__fastcall *)(CNWSDoor*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDoor*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDoor*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = Vector(__fastcall *)(CNWSDoor*, int, int32_t, unsigned char);
...
{
    using FuncPtrType = CResRef(__fastcall *)(CNWSDoor*, int);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CNWSDoor*, int);
...
{
    using FuncPtrType = Vector(__fastcall *)(CNWSDoor*, int, const Vector&, int32_t);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSDoor*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDoor*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSDoor*, int, float, float, float, float, float, float, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDoor*, int, unsigned char);
