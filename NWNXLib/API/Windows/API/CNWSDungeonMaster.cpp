...
void CNWSDungeonMaster__CNWSDungeonMasterCtor(CNWSDungeonMaster* thisPtr, uint32_t a0)
{
...
void CNWSDungeonMaster__CNWSDungeonMasterDtor__0(CNWSDungeonMaster* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSDungeonMaster__CNWSDungeonMasterDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>    (address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = CNWSDungeonMaster*(__fastcall *)(CNWSDungeonMaster*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSDungeonMaster*, int, uint32_t, unsigned char);
