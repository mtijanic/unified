...
{
    using FuncPtrType = void(__fastcall *)(CNWSEffectListHandler*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEffectListHandler*, int, CNWSObject*, CGameEffect*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEffectListHandler*, int, CNWSObject*, CGameEffect*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEffectListHandler*, int, uint32_t, uint32_t);
