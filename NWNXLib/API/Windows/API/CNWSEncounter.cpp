...
{
    CNWSEncounter__CNWSEncounterCtor(this, a0);
}
...
void CNWSEncounter__CNWSEncounterCtor(CNWSEncounter* thisPtr, uint32_t a0)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, CEncounterListEntry*, int32_t&, int32_t, CEncounterListEntry);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int);
...
{
    using FuncPtrType = CNWSEncounter*(__fastcall *)(CNWSEncounter*, int);
...
{
    using FuncPtrType = float(__fastcall *)(CNWSEncounter*, int, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CNWSEncounter*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEncounter*, int, Vector);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEncounter*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEncounter*, int, Vector, Vector);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEncounter*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, CResRef, int32_t, Vector*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, CEncounterListEntry*, int32_t&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSEncounter*, int, CResGFF*, CResStruct*, int32_t, Vector*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSEncounter*, int, uint32_t, float);
