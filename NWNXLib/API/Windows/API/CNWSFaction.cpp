...
{
    CNWSFaction__CNWSFactionCtor__1(this, a0);
}

CNWSFaction::~CNWSFaction()
{
    CNWSFaction__CNWSFactionDtor(this);
}
...
{
    using FuncPtrType = void(__fastcall *)(CNWSFaction*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSFaction*, int, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSFaction*, int, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSFaction*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSFaction*, int, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSFaction*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = CFactionManager*(__fastcall *)(CNWSFaction*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSFaction*, int, int32_t, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSFaction*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSFaction*, int, uint32_t**);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSFaction*, int, uint32_t, CExoString);
