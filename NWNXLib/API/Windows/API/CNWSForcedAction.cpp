...
CNWSForcedAction::~CNWSForcedAction()
{
    CNWSForcedAction__CNWSForcedActionDtor(this);
}
...
void CNWSForcedAction__CNWSForcedActionCtor(CNWSForcedAction* thisPtr)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSForcedAction*, int, CResGFF*, CResStruct*);
