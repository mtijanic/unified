...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSInventory*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSInventory*, int, CNWSItem*);
...
{
    using FuncPtrType = CNWSItem*(__fastcall *)(CNWSInventory*, int, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSInventory*, int, CNWSItem*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSInventory*, int, uint32_t, CNWSItem*);
