...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CNWSItem**, uint32_t, unsigned char, unsigned char, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, uint16_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, CNWItemProperty);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, CNWSCreature*, uint32_t, int32_t);
...
{
    using FuncPtrType = CNWSItem*(__fastcall *)(CNWSItem*, int);
...
{
    using FuncPtrType = float(__fastcall *)(CNWSItem*, int, CNWItemProperty*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CNWSItem*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CNWSItem*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = CNWItemProperty*(__fastcall *)(CNWSItem*, int, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSItem*, int, int32_t, int32_t, int32_t, int32_t);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CNWSItem*, int);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CNWSItem*, int);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSItem*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CNWItemProperty**, uint16_t, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, uint16_t, uint16_t);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CNWSItem*, int, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CResGFF*, CResStruct*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CResRef, CExoString*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, CNWSCreature*, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, CNWItemProperty*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItem*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItem*, int, uint32_t, int32_t, int32_t, int32_t);
...
{
    using FuncPtrType = CNWSItem*(__fastcall *)(CNWSItem*, int, int32_t);
