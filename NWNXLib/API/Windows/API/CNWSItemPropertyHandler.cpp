...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItemPropertyHandler*, int, CNWSItem*, CNWItemProperty*, CNWSCreature*, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItemPropertyHandler*, int, CNWSItem*, int32_t, CNWItemProperty*, CNWSCreature*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSItemPropertyHandler*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSItemPropertyHandler*, int, CNWSItem*, CNWItemProperty*, CNWSCreature*, uint32_t);
