...
{
    using FuncPtrType = void(__fastcall *)(CNWSJournal*, int, CExoString);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSJournal*, int, CExoString, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSJournal*, int, CExoString, int32_t, int32_t);
