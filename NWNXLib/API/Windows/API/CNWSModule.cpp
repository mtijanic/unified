...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CExoString, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, CNWSPlayerTURD*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, int32_t, CExoString, CExoString, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, uint32_t, uint32_t, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int);
...
{
    using FuncPtrType = CNWSModule*(__fastcall *)(CNWSModule*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CPathfindInformation*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, const CExoString&, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, const CExoString&, int32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, char*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, int32_t, CPathfindInformation*, uint32_t**);
...
{
    using FuncPtrType = CNWSArea*(__fastcall *)(CNWSModule*, int, uint32_t);
...
{
    using FuncPtrType = CNWSArea*(__fastcall *)(CNWSModule*, int, CResRef);
...
{
    using FuncPtrType = CNWSArea*(__fastcall *)(CNWSModule*, int, CExoString&);
...
{
    using FuncPtrType = unsigned char*(__fastcall *)(CNWSModule*, int, CExoString);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, CNWSPlayer*);
...
{
    using FuncPtrType = CNWSPlayerTURD*(__fastcall *)(CNWSModule*, int, CNWSPlayer*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, uint32_t*, uint32_t*, uint32_t*, uint32_t*, unsigned char*, uint32_t*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, const CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, int32_t, int32_t, CPathfindInformation*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, uint32_t);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSModule*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CResGFF*, CResStruct*, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, int32_t, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, CExoString, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, CNWSPlayer*, CExoArrayListTemplatedNWPlayerCharacterList_stPtr&);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSModule*, int, CPathfindInformation*, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, CNWSPlayer*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CERFFile*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CExoString&, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CResGFF*, CResStruct*, CERFFile*, CExoString&, CExoArrayListTemplatedunsignedlong&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, CExoString&, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CResGFF*, CResStruct*, CExoString&, CExoArrayListTemplatedunsignedlong&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSModule*, int, CERFFile*, CExoString, uint16_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, CPathfindInformation*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSModule*, int, uint32_t, uint32_t, uint32_t);
