...
void CNWSPlaceable__CNWSPlaceableCtor(CNWSPlaceable* thisPtr, uint32_t a0)
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int, uint32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSPlaceable__CNWSPlaceableCtor);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, CNWSItem**, uint32_t, unsigned char, unsigned char, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlaceable*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, uint32_t, int32_t, Vector, uint32_t, int32_t, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlaceable*, int, CNWSObjectActionNode*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = CNWSPlaceable*(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = uint16_t(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = CResRef(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlaceable*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int);
...
{
    using FuncPtrType = Vector(__fastcall *)(CNWSPlaceable*, int, const Vector&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, CResRef, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, CResGFF*, CResStruct*, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, CNWSItem*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlaceable*, int, CResGFF*, CResStruct*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlaceable*, int, Vector);
