...
CNWSPlayerInventoryGUI::~CNWSPlayerInventoryGUI()
{
    CNWSPlayerInventoryGUI__CNWSPlayerInventoryGUIDtor(this);
}
...
void CNWSPlayerInventoryGUI__CNWSPlayerInventoryGUICtor(CNWSPlayerInventoryGUI* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerInventoryGUI*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerInventoryGUI*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerInventoryGUI*, int, CNWSPlayer*, unsigned char);
