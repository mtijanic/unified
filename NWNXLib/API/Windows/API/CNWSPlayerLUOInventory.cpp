...
{
    CNWSPlayerLUOInventory__CNWSPlayerLUOInventoryCtor(this);
}

CNWSPlayerLUOInventory::~CNWSPlayerLUOInventory()
{
    CNWSPlayerLUOInventory__CNWSPlayerLUOInventoryDtor(this);
}
...
void CNWSPlayerLUOInventory__CNWSPlayerLUOInventoryCtor(CNWSPlayerLUOInventory* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLUOInventory*, int, uint32_t, unsigned char, unsigned char, unsigned char, uint32_t, uint32_t);
...
{
    using FuncPtrType = CNWSItem*(__fastcall *)(CNWSPlayerLUOInventory*, int, CExoLinkedListNode*, unsigned char);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlayerLUOInventory*, int, CExoLinkedListNode*, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLUOInventory*, int, CExoLinkedListNode*, unsigned char);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlayerLUOInventory*, int, unsigned char);
...
{
    using FuncPtrType = CNWSPlayerLUOInventoryItem*(__fastcall *)(CNWSPlayerLUOInventory*, int, CExoLinkedListNode*, unsigned char);
