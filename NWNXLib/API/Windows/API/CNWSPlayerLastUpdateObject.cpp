...
{
    CNWSPlayerLastUpdateObject__CNWSPlayerLastUpdateObjectCtor(this);
}

CNWSPlayerLastUpdateObject::~CNWSPlayerLastUpdateObject()
{
    CNWSPlayerLastUpdateObject__CNWSPlayerLastUpdateObjectDtor(this);
}
...
void CNWSPlayerLastUpdateObject__CNWSPlayerLastUpdateObjectCtor(CNWSPlayerLastUpdateObject* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, unsigned char);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, unsigned char);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, unsigned char);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSPlayerLastUpdateObject*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLastUpdateObject*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, unsigned char, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSPlayerLastUpdateObject*, int, unsigned char, unsigned char, unsigned char, uint32_t, int32_t, unsigned char);
