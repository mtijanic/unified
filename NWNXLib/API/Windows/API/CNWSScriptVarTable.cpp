...
{
    CNWSScriptVarTable__CNWSScriptVarTableDtor(this);
}
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CExoString&, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CExoString&);
...
{
    using FuncPtrType = float(__fastcall *)(CNWSScriptVarTable*, int, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSScriptVarTable*, int, CExoString&);
...
{
    using FuncPtrType = CScriptLocation(__fastcall *)(CNWSScriptVarTable*, int, CExoString&);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSScriptVarTable*, int, CExoString&);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWSScriptVarTable*, int, CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = CNWSScriptVar*(__fastcall *)(CNWSScriptVarTable*, int, CExoString&, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CExoString&, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CExoString&, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CExoString&, CScriptLocation);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSScriptVarTable*, int, CExoString&, CExoString&);
