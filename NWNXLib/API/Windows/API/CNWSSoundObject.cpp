...
void CNWSSoundObject__CNWSSoundObjectDtor__0(CNWSSoundObject* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWSSoundObject__CNWSSoundObjectDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>    (address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int, CNWSArea*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int);
...
{
    using FuncPtrType = CNWSSoundObject*(__fastcall *)(CNWSSoundObject*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int, Vector);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = CExoArrayListTemplatedunsignedlong(__fastcall *)(CNWSSoundObject*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSSoundObject*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int, CNWSMessage*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSSoundObject*, int, CResGFF*, CResStruct*);
