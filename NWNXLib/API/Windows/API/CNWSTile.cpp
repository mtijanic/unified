...
void CNWSTile__CNWSTileCtor(CNWSTile* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTile*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, int32_t, Vector, Vector, Vector*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, float, float, float, float, float*, float*, float*, float*, float*, float*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, Vector, Vector, Vector*, Vector*);
...
{
    using FuncPtrType = float(__fastcall *)(CNWSTile*, int, Vector);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, float, float);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, int32_t, float*, float*, int32_t*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, int32_t, float*, float*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, Vector);
...
{
    using FuncPtrType = CNWTileData*(__fastcall *)(CNWSTile*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int);
...
{
    using FuncPtrType = CResRef(__fastcall *)(CNWSTile*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, Vector, CExoArrayListTemplatedunsignedlong*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTile*, int, float, float, float, float, float, float, float, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSTile*, int, CNWArea*, CPathfindInformation*, float, float, float, float, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTile*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTile*, int, CNWTileData*);
