...
{
    using FuncPtrType = void(__fastcall *)(CNWSTransition*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = CNWSObject*(__fastcall *)(CNWSTransition*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTransition*, int, const CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTransition*, int, CNWSObject*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTransition*, int, int32_t);
