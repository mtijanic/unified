...
{
    CNWSTrigger__CNWSTriggerCtor(this, a0);
}
...
void CNWSTrigger__CNWSTriggerCtor(CNWSTrigger* thisPtr, uint32_t a0)
{
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int);
...
{
    using FuncPtrType = CNWSTrigger*(__fastcall *)(CNWSTrigger*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTrigger*, int, Vector, Vector*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int, float*, float*, float*, float*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int, float, Vector, CNWSArea*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int, float, CScriptLocation*, CNWSArea*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTrigger*, int, uint32_t, int32_t);
...
{
    using FuncPtrType = Vector(__fastcall *)(CNWSTrigger*, int);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CNWSTrigger*, int);
...
{
    using FuncPtrType = CExoString*(__fastcall *)(CNWSTrigger*, int, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSTrigger*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTrigger*, int, Vector);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTrigger*, int, CResRef);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSTrigger*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSTrigger*, int, int32_t);
