...
{
    using FuncPtrType = void(__fastcall *)(CNWSWaypoint*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSWaypoint*, int, CNWSArea*, float, float, float, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSWaypoint*, int);
...
{
    using FuncPtrType = CNWSWaypoint*(__fastcall *)(CNWSWaypoint*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSWaypoint*, int, uint32_t, uint32_t, void*, uint32_t, uint32_t);
...
{
    using FuncPtrType = CExoLocString&(__fastcall *)(CNWSWaypoint*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSWaypoint*, int, CResRef, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSWaypoint*, int, CResGFF*, CResStruct*, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSWaypoint*, int, CResGFF*, CResStruct*);
