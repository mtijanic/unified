...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWSpell*, int);
...
{
    using FuncPtrType = unsigned char(__fastcall *)(CNWSpell*, int, unsigned char);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWSpell*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CNWSpell*, int, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSpell*, int, unsigned char, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWSpell*, int, unsigned char);
