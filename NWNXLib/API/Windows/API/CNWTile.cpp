...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, unsigned char*, unsigned char*, unsigned char*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, int32_t*, int32_t*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, unsigned char*, unsigned char*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, float, float, float*, float*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, int32_t, int32_t, int32_t, float);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTile*, int, unsigned char);
