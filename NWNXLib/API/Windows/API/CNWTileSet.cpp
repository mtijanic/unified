...
{
    CNWTileSet__CNWTileSetCtor(this, a0, a1);
}
...
void CNWTileSet__CNWTileSetCtor(CNWTileSet* thisPtr, CResRef a0, int32_t a1)
{
    using FuncPtrType = void(__fastcall *)(CNWTileSet*, int, CResRef, int32_t);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWTileSet__CNWTileSetCtor);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTileSet*, int, int);
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CNWTileSet__CNWTileSetDtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>    (address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWTileSet*, int, int32_t, unsigned char, unsigned char);
...
{
    using FuncPtrType = CResRef(__fastcall *)(CNWTileSet*, int);
...
{
    using FuncPtrType = float(__fastcall *)(CNWTileSet*, int);
...
{
    using FuncPtrType = CNWTileData*(__fastcall *)(CNWTileSet*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWTileSet*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWTileSet*, int, char*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWTileSet*, int, char*, char*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTileSet*, int);
