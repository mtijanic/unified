...
{
    using FuncPtrType = void(__fastcall *)(CNWTileSetManager*, int, unsigned char, int32_t, int32_t&, int32_t&, float**, float**, int32_t**);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTileSetManager*, int, int32_t, float*, float*);
...
{
    using FuncPtrType = CNWTilePathNode*(__fastcall *)(CNWTileSetManager*, int, unsigned char, unsigned char);
...
{
    using FuncPtrType = CNWTileSet*(__fastcall *)(CNWTileSetManager*, int, CResRef);
...
{
    using FuncPtrType = void(__fastcall *)(CNWTileSetManager*, int, CNWTileSet*);
