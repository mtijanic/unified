...
{
    using FuncPtrType = void*(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t, void*);
...
{
    using FuncPtrType = void*(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWVirtualMachineCommands*, int, char**, int32_t*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWVirtualMachineCommands*, int, char*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWVirtualMachineCommands*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CNWVirtualMachineCommands*, int);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t, void*, int32_t*, CExoString**, CExoString**);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t, void*, void*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWVirtualMachineCommands*, int, uint32_t, int32_t*, CExoString**, CExoString**);
...
{
    using FuncPtrType = C2DA*(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNWVirtualMachineCommands*, int, int32_t, void**, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = void(__fastcall *)(CNWVirtualMachineCommands*, int, CExoString&, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNWVirtualMachineCommands*, int, CExoString&);
