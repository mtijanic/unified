...
{
    CNetLayerWindow__CNetLayerWindowCtor(this);
}

CNetLayerWindow::~CNetLayerWindow()
{
    CNetLayerWindow__CNetLayerWindowDtor(this);
}
...
void CNetLayerWindow__CNetLayerWindowCtor(CNetLayerWindow* thisPtr)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int, uint32_t, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int, unsigned char*, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNetLayerWindow*, int, unsigned char, uint16_t, uint16_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNetLayerWindow*, int, CNetLayerInternal*);
...
{
    using FuncPtrType = void(__fastcall *)(CNetLayerWindow*, int, uint16_t);
...
{
    using FuncPtrType = void(__fastcall *)(CNetLayerWindow*, int, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int, uint32_t, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CNetLayerWindow*, int, int32_t);
