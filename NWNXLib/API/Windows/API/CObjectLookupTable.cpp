...
{
    using FuncPtrType = uint32_t(__fastcall *)(CObjectLookupTable*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CObjectLookupTable*, int, void*, uint32_t*);
...
{
    using FuncPtrType = void(__fastcall *)(CObjectLookupTable*, int, uint32_t);
