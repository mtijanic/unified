...
{
    CPathfindInformation__CPathfindInformationCtor(this);
}

CPathfindInformation::~CPathfindInformation()
{
    CPathfindInformation__CPathfindInformationDtor(this);
}
...
void CPathfindInformation__CPathfindInformationCtor(CPathfindInformation* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CPathfindInformation*, int, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CPathfindInformation*, int, int32_t, int32_t*, int32_t*, CPathfindInfoIntraTileSuccessors**);
