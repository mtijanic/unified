...
{
    using FuncPtrType = int32_t(__fastcall *)(CRes*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CRes*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CRes*, int, int32_t, char*);
