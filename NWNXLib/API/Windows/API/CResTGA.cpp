...
void CResTGA__CResTGACtor(CResTGA* thisPtr)
{
...
void CResTGA__CResTGADtor__0(CResTGA* thisPtr)
{
    ...
    uintptr_t address = Platform::ASLR::GetRelocatedAddress(Functions::CResTGA__CResTGADtor);
    FuncPtrType func = reinterpret_cast<FuncPtrType>    (address);
    int edx = 0;
    func(thisPtr, edx, 2);
}
...
{
    using FuncPtrType = int32_t(__fastcall *)(CResTGA*, int, unsigned char*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CResTGA*, int, uint32_t*, uint32_t*, unsigned char*);
...
{
    using FuncPtrType = unsigned char*(__fastcall *)(CResTGA*, int);
...
{
    using FuncPtrType = ExoTGAHeader_st*(__fastcall *)(CResTGA*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CResTGA*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CResTGA*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CResTGA*, int, CExoString&);
