...
{
    using FuncPtrType = void(__fastcall *)(CScriptEvent*, int, CScriptEvent*);
...
{
    using FuncPtrType = float(__fastcall *)(CScriptEvent*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CScriptEvent*, int, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CScriptEvent*, int, int32_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CScriptEvent*, int, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CScriptEvent*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CScriptEvent*, int, const CScriptEvent&);
...
{
    using FuncPtrType = void(__fastcall *)(CScriptEvent*, int, int32_t, float);
...
{
    using FuncPtrType = void(__fastcall *)(CScriptEvent*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CScriptEvent*, int, int32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CScriptEvent*, int, int32_t, CExoString);
