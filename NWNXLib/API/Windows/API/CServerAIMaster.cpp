...
CServerAIMaster::~CServerAIMaster()
{
    CServerAIMaster__CServerAIMasterDtor(this);
}
...
void CServerAIMaster__CServerAIMasterCtor(CServerAIMaster* thisPtr)
{
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, void*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CNWSObject*, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CServerAIMaster*, int, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CServerAIMaster*, int, CExoString);
...
{
    using FuncPtrType = void(__fastcall *)(CServerAIMaster*, int, uint32_t, void*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, uint32_t, uint32_t);
...
{
    using FuncPtrType = CExoString*(__fastcall *)(CServerAIMaster*, int);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CNWSObject*, CGameEffect*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CNWSObject*, CGameEffect*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CNWSItem*, CNWItemProperty*, CNWSCreature*, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CNWSItem*, CNWItemProperty*, CNWSCreature*, uint32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CServerAIMaster*, int, CNWSObject*);
...
{
    using FuncPtrType = void(__fastcall *)(CServerAIMaster*, int, CServerExoAppInternal*);
