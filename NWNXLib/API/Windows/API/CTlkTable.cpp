...
{
    using FuncPtrType = void(__fastcall *)(CTlkTable*, int, CTlkFile**);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CTlkTable*, int, uint32_t, STR_RES&, int32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CTlkTable*, int);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CTlkTable*, int, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CTlkTable*, int, const CTlkTableToken&, CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CTlkTable*, int, CExoString);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CTlkTable*, int, const CExoString&, CTlkFile**);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CTlkTable*, int, const CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CTlkTable*, int, CExoString&);
...
{
    using FuncPtrType = char*(__fastcall *)(CTlkTable*, int, char*);
...
{
    using FuncPtrType = void(__fastcall *)(CTlkTable*, int, int32_t, const CExoString&);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CTlkTable*, int, int32_t);
