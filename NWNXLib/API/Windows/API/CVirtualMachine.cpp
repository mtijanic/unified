...
{
    CVirtualMachine__CVirtualMachineCtor(this);
}

CVirtualMachine::~CVirtualMachine()
{
    CVirtualMachine__CVirtualMachineDtor(this);
}
...
void CVirtualMachine__CVirtualMachineCtor(CVirtualMachine* thisPtr)
{
...
{
    using FuncPtrType = void(__fastcall *)(CVirtualMachine*, int, int32_t*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, CVirtualMachineScript*);
...
{
    using FuncPtrType = void(__fastcall *)(CVirtualMachine*, int, void*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, int32_t*, char*, int32_t, CVirtualMachineDebuggingContext*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, int32_t*, void**);
...
{
    using FuncPtrType = CScriptLog*(__fastcall *)(CVirtualMachine*, int, const CExoString&);
...
{
    using FuncPtrType = void(__fastcall *)(CVirtualMachine*, int, CVirtualMachineScript*, char*, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, CVirtualMachineScript**, CResGFF*, CResStruct*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, int32_t*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, CExoString*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, CExoString*, uint32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, void*, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CVirtualMachine*, int, CVirtualMachineCmdImplementer*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, float*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, uint32_t*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, Vector*);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CVirtualMachine*, int, const CExoString&);
