...
CWorldTimer::~CWorldTimer()
{
    CWorldTimer__CWorldTimerDtor(this);
}
...
void CWorldTimer__CWorldTimerCtor(CWorldTimer* thisPtr)
{
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t*, uint32_t*);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, int32_t, int32_t, int32_t, int32_t);
...
{
    using FuncPtrType = int32_t(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t*, uint32_t*, uint32_t*);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t*, uint32_t*, uint32_t*, uint32_t*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, uint32_t, uint32_t);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CWorldTimer*, int, float);
...
{
    using FuncPtrType = uint64_t(__fastcall *)(CWorldTimer*, int);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, uint32_t*, uint32_t*);
...
{
    using FuncPtrType = uint32_t(__fastcall *)(CWorldTimer*, int);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CWorldTimer*, int);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, CWorldTimer*);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, int32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, unsigned char);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = void(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, int32_t);
...
{
    using FuncPtrType = CExoString(__fastcall *)(CWorldTimer*, int, uint32_t, uint32_t, CExoString&, CExoString&);
